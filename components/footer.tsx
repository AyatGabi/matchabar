          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-2 text-sm text-muted-foreground">
                <p>{"Kampala, Uganda"}</p>
                <p>{"WhatsApp: +256 760 155051"}</p>
                <a 
                  href="https://www.instagram.com/matcha.bar.ug?igsh=MWJ5Yjc3Z2d0MGtuMg%3D%3D&utm_source=qr" 
                  target="_blank" 
                  rel="noopener noreferrer"
                  className="block hover:text-matcha-deep transition-colors"
                >
                  {"Instagram: @matcha.bar.ug"}
                </a>
              </div>
            </div>
